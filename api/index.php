...
$app->get('/amp/{pcode}', function($request, $response){  
    ...
    $sql = "select distinct c_x, c_y, amp_code, amp_nam_t, prov_code from ln9p_amp where prov_code = '$pcode'";
    $rs = pg_query($sql);
...
$app->get('/tam/{acode}', function($request, $response){  
    ...
    $sql = "select distinct c_x, c_y, tam_code, tam_nam_t, amp_code from ln9p_tam where amp_code = '$acode'";
    $rs = pg_query($sql);
...
$app->get('/vill/{tcode}', function($request, $response){  
    ...
    $sql = "select distinct c_x, c_y, vill_code, vill_nam_t, tam_code from ln9p_vill where tam_code = '$tcode'";
    $rs = pg_query($sql);
