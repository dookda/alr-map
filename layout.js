...
/*       {
        searchPanel: {
            xtype: "hr_formsearchpanel",
            name: "หมายเลขระวางภาพ ortho 1:4,000",
            protocol: new OpenLayers.Protocol.WFS({
                version: "1.1.0",
                url: "http://map.nu.ac.th:8080/geoserver/ows?",
                srsName: "EPSG:3857",
                featureType: "index_ortho4k", //gisldd:index_ortho4k
                maxFeatures: 1000
            }),
            downloadFormats: Heron.options.wfs.downloadFormats, //Heron.options.wfs.downloadFormats
            items: [{
        ...
        searchPanel: {
            xtype: "hr_formsearchpanel",
            name: "หมายเลขระวางเส้นชั้นความสูง",
            protocol: new OpenLayers.Protocol.WFS({
                version: "1.1.0",
                url: "http://map.nu.ac.th:8080/geoserver/ows?",
                srsName: "EPSG:3857",
                featureType: "index_contour4k", //gisldd:index_ortho4k
                maxFeatures: 1000
            }),
            downloadFormats: Heron.options.wfs.downloadFormats, //Heron.options.wfs.downloadFormats
            items: [{
        ...
        searchPanel: {
            xtype: "hr_formsearchpanel",
            name: "หมายเลขระวางแบบจำลองระดับสูงเชิงเลข",
            protocol: new OpenLayers.Protocol.WFS({
                version: "1.1.0",
                url: "http://map.nu.ac.th:8080/geoserver/ows?",
                srsName: "EPSG:3857",
                featureType: "index_dem4k", //gisldd:index_ortho4k
                maxFeatures: 1000
            }),
            downloadFormats: Heron.options.wfs.downloadFormats, //Heron.options.wfs.downloadFormats
            items: [{
        ...
        searchPanel: {
            xtype: "hr_formsearchpanel",
            name: "หมายเลขหมุดหลักฐานภาคพื้นดิน",
            protocol: new OpenLayers.Protocol.WFS({
                version: "1.1.0",
                url: "http://map.nu.ac.th:8080/geoserver/ows?",
                srsName: "EPSG:3857",
                featureType: "gcp", //gisldd:index_ortho4k
                maxFeatures: 1000
            }),
            downloadFormats: Heron.options.wfs.downloadFormats, //Heron.options.wfs.downloadFormats
            items: [{
        ...
        searchPanel: {
            xtype: "hr_formsearchpanel",
            name: "สารบัญแนวบินภาพถ่ายทางอากาศ",
            protocol: new OpenLayers.Protocol.WFS({
                version: "1.1.0",
                url: "http://map.nu.ac.th:8080/geoserver/ows?",
                srsName: "EPSG:3857",
                featureType: "index_photo25k", //gisldd:index_ortho4k
                maxFeatures: 1000
            }),
            downloadFormats: Heron.options.wfs.downloadFormats, //Heron.options.wfs.downloadFormats
            items: [{
